...
#include "modules/filter/imageItk/SMatrixRegressor.hpp"
...
#include <filter/imageItk/MatrixRegressor.hpp>
...
void SMatrixRegressor::updating()
{
    ...
    std::vector<sight::filter::imageItk::MatrixRegressor::PointType> ptList;
    ...
    for(const auto& pt : pointList->getPoints())
    {
        ...
        ptList.push_back(
            sight::filter::imageItk::MatrixRegressor::PointType(
                ptCoords[0],
                ptCoords[1],
                ptCoords[2],
                1.
    ...
    {
        sight::filter::imageItk::MatrixRegressor regressor(matrixList.get_shared(), ptList);

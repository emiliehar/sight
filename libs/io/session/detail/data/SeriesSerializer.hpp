...
class SeriesSerializer : public IDataSerializer
{
public:
    ...
    SeriesSerializer& operator=(const SeriesSerializer&) = delete;
    SeriesSerializer& operator=(SeriesSerializer&&)      = delete;

    /// Default destructor. Public to allow unique_ptr
    ~SeriesSerializer() override = default;

    /// Factories
    static SeriesSerializer::sptr shared();

    static SeriesSerializer::uptr unique();

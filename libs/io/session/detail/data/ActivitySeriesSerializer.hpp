...
class ActivitySeriesSerializer : public IDataSerializer
{
public:
    ...
    ActivitySeriesSerializer(ActivitySeriesSerializer&&)                 = delete;
    ActivitySeriesSerializer& operator=(const ActivitySeriesSerializer&) = delete;
    ActivitySeriesSerializer& operator=(ActivitySeriesSerializer&&)      = delete;

    /// Default destructor. Public to allow unique_ptr
    ~ActivitySeriesSerializer() override = default;

    /// Factories
    static ActivitySeriesSerializer::sptr shared();

    static ActivitySeriesSerializer::uptr unique();
...
protected:
    ...
    /// Default constructor
    ActivitySeriesSerializer() = default;
};

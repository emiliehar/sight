...
void NumericRoundCastTest::castFloatToIntTest()
{
    ...
    val = 4826.2f;
    const std::uint16_t castedVal2 = core::tools::numericRoundCast<std::uint16_t>(val);
...
{
    double val1             = 895.33;
    unsigned int castedVal1 = core::tools::numericRoundCast<unsigned int>(val1);
...
{
    int val1         = 55;
    float castedVal1 = core::tools::numericRoundCast<float>(val1);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(55.0f, castedVal1, 0.00000001);

    int val2         = -4564;
    float castedVal2 = core::tools::numericRoundCast<float>(val2);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(-4564.0f, castedVal2, 0.00000001);

    unsigned short val3 = 5394;
    double castedVal3   = core::tools::numericRoundCast<double>(val3);
...
{
    double val      = 55.678;
    float castedVal = core::tools::numericRoundCast<float>(val);
...
void NumericRoundCastTest::castIntToIntTest()
{
    ...
    unsigned char castedVal1 = core::tools::numericRoundCast<unsigned char>(val1);
    CPPUNIT_ASSERT_EQUAL(static_cast<unsigned char>(153), castedVal1);

    unsigned char val2       = 25;
    unsigned char castedVal2 = core::tools::numericRoundCast<unsigned char>(val2);
    CPPUNIT_ASSERT_EQUAL(static_cast<unsigned char>(25), castedVal2);

    char val3                 = 121;
    unsigned short castedVal3 = core::tools::numericRoundCast<unsigned char>(val3);

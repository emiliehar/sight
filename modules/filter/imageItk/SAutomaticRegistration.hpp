...
#include <filter/imageItk/AutomaticRegistration.hpp>
 ...
 */
class MODULE_FILTER_IMAGEITK_CLASS_API SAutomaticRegistration : public service::IOperator
{
public:
    ...
    MODULE_FILTER_IMAGEITK_API SAutomaticRegistration();
...
private:
    ...
    sight::filter::imageItk::MetricType m_metric;

    /// Shrink factors per level and smoothing sigmas per level.
    sight::filter::imageItk::AutomaticRegistration::MultiResolutionParametersType m_multiResolutionParameters;

    /// Percentage of samples used for registration.
    sight::filter::imageItk::AutomaticRegistration::RealType m_samplingPercentage;
};

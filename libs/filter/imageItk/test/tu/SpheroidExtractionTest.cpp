...
#include <filter/imageItk/SpheroidExtraction.hpp>
...
CPPUNIT_TEST_SUITE_REGISTRATION(::sight::filter::imageItk::ut::SpheroidExtractionTest);
...
void SpheroidExtractionTest::extractionTest()
{
    ...
    data::PointList::sptr extractedSpheroids =
        filter::imageItk::SpheroidExtraction::extract(image, 200., 4., 9., 0.8, 1.2);

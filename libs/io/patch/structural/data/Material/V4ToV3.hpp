...
/// Structural patch to convert a data::Material from version '4' to version '3'.
class IO_PATCH_CLASS_API V4ToV3 : public io::atoms::patch::IStructuralPatch
{
public:
    SIGHT_DECLARE_CLASS(V4ToV3, patch::structural::data::Material::V4ToV3, new V4ToV3)
    ...
    /// Copy constructor
    IO_PATCH_API V4ToV3(const V4ToV3& cpy);

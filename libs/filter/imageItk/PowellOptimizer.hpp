 ...
 */
class FILTER_IMAGEITK_CLASS_API PowellOptimizer
{
public:
     ...
     */
    FILTER_IMAGEITK_API PowellOptimizer(
     ...
     */
    FILTER_IMAGEITK_API FunctionParametersType optimize(const FunctionParametersType& _initParameters);

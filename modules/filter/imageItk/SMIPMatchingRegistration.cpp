...
void SMIPMatchingRegistration::updating()
{
    ...
    sight::filter::imageItk::RegistrationDispatch::Parameters params;
    params.fixed     = fixed;
...

    {
        ...
        core::tools::Dispatcher<core::tools::SupportedDispatcherTypes, sight::filter::imageItk::RegistrationDispatch>
        ::invoke(type, params);
    }

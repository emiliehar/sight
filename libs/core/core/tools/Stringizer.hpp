...
template<>
CORE_API std::string getString(const std::string& aString);

template<>
CORE_API std::string getString(const std::type_info& ti);

template<>
CORE_API std::string getString(const TypeInfo& ti);

// char are numerically casted
template<>
CORE_API std::string getString(const signed char& c);

// char are numerically casted // signed char and char doesn't are the same :/ !!!!
template<>
CORE_API std::string getString(const char& c);

// char are numerically casted
template<>
CORE_API std::string getString(const unsigned char& c);

...
/// Structural patch to convert a data::CameraSeries from version '2' to version '3'.
class IO_PATCH_CLASS_API V2ToV3 : public io::atoms::patch::IStructuralPatch
{
public:
    SIGHT_DECLARE_CLASS(V2ToV3, patch::structural::data::CameraSeries::V2ToV3, new V2ToV3)

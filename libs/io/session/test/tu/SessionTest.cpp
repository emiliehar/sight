...
{
    // Test nominal SessionSerializer creation
    {
        auto sessionSerializer = io::session::detail::SessionSerializer::unique();
        CPPUNIT_ASSERT(sessionSerializer);
    }

    // Test nominal SessionSerializer creation
    {
        auto sessionDeserializer = io::session::detail::SessionDeserializer::unique();
        CPPUNIT_ASSERT(sessionDeserializer);
    }
}

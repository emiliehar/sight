...
CPPUNIT_TEST_SUITE_REGISTRATION(::sight::io::patch::structural::ut::data::CameraSeries::V2ToV3Test);
...
{
    sight::atoms::Object::sptr CameraSeriesV2 = sight::atoms::Object::New();
    sight::atoms::Object::sptr CameraSeriesV3;

    io::atoms::patch::helper::setClassname(CameraSeriesV2, "data::CameraSeries");
    io::atoms::patch::helper::setVersion(CameraSeriesV2, "2");

    io::atoms::patch::helper::Object helper(CameraSeriesV2);
    ...
    helper.addAttribute("cameras", sight::atoms::Object::sptr());
    helper.addAttribute("extrinsic_matrices", sight::atoms::Object::sptr());

    {
        CameraSeriesV3 = sight::atoms::Object::dynamicCast(CameraSeriesV2->clone());

        io::atoms::patch::IPatch::NewVersionsType newVersions;
        newVersions[CameraSeriesV2] = CameraSeriesV3;

        patch::structural::data::CameraSeries::V2ToV3::sptr v2ToV3Patch;
        v2ToV3Patch = patch::structural::data::CameraSeries::V2ToV3::New();
        CPPUNIT_ASSERT_NO_THROW(v2ToV3Patch->apply(CameraSeriesV2, CameraSeriesV3, newVersions));

        CPPUNIT_ASSERT(CameraSeriesV3);
        CPPUNIT_ASSERT_EQUAL(std::string("3"), io::atoms::patch::helper::getVersion(CameraSeriesV3));

 ...
 * @code{.xml}
   <service type="sight::module::filter::imageItk::SMatrixRegressor">
 ...
 */
class MODULE_FILTER_IMAGEITK_CLASS_API SMatrixRegressor : public service::IOperator
{
public:
    ...
    /// Does nothing.
    MODULE_FILTER_IMAGEITK_API SMatrixRegressor();

    /// Destroys the service.
    MODULE_FILTER_IMAGEITK_API ~SMatrixRegressor() override;

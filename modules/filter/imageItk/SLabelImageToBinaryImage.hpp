 ...
 * @code{.xml}
   <service type="sight::module::filter::imageItk::SLabelImageToBinaryImage">
 ...
 */
class MODULE_FILTER_IMAGEITK_CLASS_API SLabelImageToBinaryImage final : public service::IOperator
{
public:
    ...
    /// Does nothing.
    MODULE_FILTER_IMAGEITK_CLASS_API SLabelImageToBinaryImage();

    /// Destroys the service.
    MODULE_FILTER_IMAGEITK_CLASS_API ~SLabelImageToBinaryImage() override;

 ...
 */
class FILTER_IMAGEITK_CLASS_API MatrixRegressor
{
public:
     ...
     */
    FILTER_IMAGEITK_API MatrixRegressor(const data::Vector::csptr& matrixList, const std::vector<PointType>& points);
     ...
     */
    FILTER_IMAGEITK_API data::Matrix4::sptr minimize(

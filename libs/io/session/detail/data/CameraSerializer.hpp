...
class CameraSerializer : public IDataSerializer
{
public:

    SIGHT_DECLARE_CLASS(CameraSerializer, IDataSerializer);

    /// Delete default copy constructors and assignment operators
    CameraSerializer(const CameraSerializer&)            = delete;
    CameraSerializer(CameraSerializer&&)                 = delete;
    CameraSerializer& operator=(const CameraSerializer&) = delete;
    CameraSerializer& operator=(CameraSerializer&&)      = delete;

    /// Default constructor
    CameraSerializer() = default;

    /// Default destructor
    ~CameraSerializer() override = default;

 ...
 * @code{.xml}
       <service uid="..." type="sight::module::filter::imageItk::SLabelGeometryImage">
           <inout key="image" uid="..."/>
 ...
 */
class MODULE_FILTER_IMAGEITK_CLASS_API SLabelGeometryImage final : public service::IOperator
{
public:
    ...
    /// Initializes slots.
    MODULE_FILTER_IMAGEITK_API SLabelGeometryImage();

    /// Destroys the service.
    MODULE_FILTER_IMAGEITK_API ~SLabelGeometryImage() override;

 ...
 *
 * @code{.xml}
   <service type="sight::module::filter::imageItk::SImagesSubstract">
       <in key="image1" uid="..." />
       <in key="image2" uid="..." />
...
class MODULE_FILTER_IMAGEITK_CLASS_API SImagesSubstract final : public service::IOperator
{
public:

    SIGHT_DECLARE_SERVICE(SImagesSubstract, ::sight::service::IOperator);

    MODULE_FILTER_IMAGEITK_API SImagesSubstract()          = default;
    MODULE_FILTER_IMAGEITK_API virtual ~SImagesSubstract() = default;
...
protected:
    ...
    /// Overrides
    MODULE_FILTER_IMAGEITK_API void swapping() override;
};

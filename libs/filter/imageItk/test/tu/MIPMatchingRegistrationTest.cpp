...
#include <filter/imageItk/MIPMatchingRegistration.hpp>
...
CPPUNIT_TEST_SUITE_REGISTRATION(sight::filter::imageItk::ut::MIPMatchingRegistrationTest);
...
void MIPMatchingRegistrationTest::identityTest()
{
    ...
    filter::imageItk::RegistrationDispatch::Parameters params;
    params.fixed     = fixed;
...
void MIPMatchingRegistrationTest::translateTransformTest()
{
    ...
    sight::filter::imageItk::Resampler::resample(moving, fixed, transform);

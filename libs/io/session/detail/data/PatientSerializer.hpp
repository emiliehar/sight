...
class PatientSerializer : public IDataSerializer
{
public:
    ...
    PatientSerializer(PatientSerializer&&)                 = delete;
    PatientSerializer& operator=(const PatientSerializer&) = delete;
    PatientSerializer& operator=(PatientSerializer&&)      = delete;

    /// Default destructor. Public to allow unique_ptr
    ~PatientSerializer() override = default;

    /// Factories
    static PatientSerializer::sptr shared();

    static PatientSerializer::uptr unique();

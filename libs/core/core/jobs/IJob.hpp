...
public:
    ...
    CORE_API std::uint64_t getDoneWorkUnits() const;

    /// Getter on the total number of work units.
    CORE_API std::uint64_t getTotalWorkUnits() const;

    /// Getter on the current State. @see State
    CORE_API State getState() const;

    /// Getter on the name of the job.
    CORE_API const std::string& getName() const;

    /// Getter on the log container
    CORE_API Logs getLogs() const;

    /// Getter on cancelable, returns whether the job is cancelable.
    CORE_API bool isCancelable() const;

    /// Setter on cancelable.
    CORE_API void setCancelable(bool cancel);
     ...
     */
    CORE_API void addSimpleCancelHook(CancelHook callback);
     ...
     */
    CORE_API void addCancelHook(JobCancelHook callback);
     ...
     */
    CORE_API void addDoneWorkHook(DoneWorkHook callback);
     ...
     */
    CORE_API void addTotalWorkUnitsHook(TotalWorkUnitsHook callback);
     ...
     */
    CORE_API void addLogHook(LogHook callback);
     ...
     */
    CORE_API void addStateHook(StateHook callback);
...
protected:
     ...
     */
    CORE_API void setTotalWorkUnits(std::uint64_t units);
     ...
     */
    CORE_API void addCancelHookNoLock(JobCancelHook callback);
     ...
     * @param callback job done work unit callback, taking a IJob as parameter
     */
    CORE_API void addDoneWorkHookNoLock(DoneWorkHook callback);
     ...
     * @param callback job work unit callback, taking a IJob as parameter
     */
    CORE_API void addTotalWorkUnitsHookNoLock(TotalWorkUnitsHook callback);
     ...
     * @param callback job log callback, taking a std::string message as parameter
     */
    CORE_API void addLogHookNoLock(LogHook callback);
     ...
     */
    CORE_API void addStateHookNoLock(StateHook callback);
     ...
     */
    CORE_API void logNoLock(const std::string& message);

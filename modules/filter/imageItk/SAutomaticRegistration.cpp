...
{
    using sight::filter::imageItk::AutomaticRegistration;
...
void SAutomaticRegistration::setMetric(const std::string& metricName)
{
    ...
    {
        m_metric = sight::filter::imageItk::MEAN_SQUARES;
    }
    else if(metricName == "NormalizedCorrelation")
    {
        m_metric = sight::filter::imageItk::NORMALIZED_CORRELATION;
    }
    else if(metricName == "MutualInformation")
    {
        m_metric = sight::filter::imageItk::MUTUAL_INFORMATION;
    }
    else
    {

...
/// Structural patch to convert a data::ActivitySeries from version '1' to version '2'.
class IO_PATCH_CLASS_API V1ToV2 : public io::atoms::patch::IStructuralPatch
{
public:
    SIGHT_DECLARE_CLASS(V1ToV2, patch::structural::data::ActivitySeries::V1ToV2, new V1ToV2)

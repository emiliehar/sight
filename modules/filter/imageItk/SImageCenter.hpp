 ...
 * @code{.xml}
   <service type="sight::module::filter::imageItk::SImageCenter">
       <in key="image" uid="..." />
 ...
 *
 */
class MODULE_FILTER_IMAGEITK_CLASS_API SImageCenter : public service::IOperator
{
public:
    ...
    MODULE_FILTER_IMAGEITK_API SImageCenter();

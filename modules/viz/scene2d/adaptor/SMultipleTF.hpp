 ...
 */
class MODULE_VIZ_SCENE2D_CLASS_API SMultipleTF : public QObject,
...
public:
    ...
    MODULE_VIZ_SCENE2D_API virtual ~SMultipleTF() noexcept;
...
private:
     ...
     */
    void mouseMoveOnPointEvent(SubTF* const _subTF, const sight::viz::scene2d::data::Event& _event);
     ...
     */
    void mouseMoveOnSubTFEvent(const sight::viz::scene2d::data::Event& _event);

...
::Ogre::SceneNode* ITransformable::getTransformNode(::Ogre::SceneNode* const _parentNode, bool create)
{
    SIGHT_ASSERT("Transform id is not set, please call setTransformId before.", !m_transformId.empty());
    m_transformNode = this->getTransformNode(m_transformId, _parentNode, create);
...
)
{
    ...
    if(transformNode == nullptr && create)
    {

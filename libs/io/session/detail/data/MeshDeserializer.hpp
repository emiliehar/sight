...
class MeshDeserializer : public IDataDeserializer
{
public:
    ...
    MeshDeserializer& operator=(const MeshDeserializer&) = delete;
    MeshDeserializer& operator=(MeshDeserializer&&)      = delete;

    /// Default destructor. Public to allow unique_ptr
    ~MeshDeserializer() override = default;

    /// Factories
    static MeshDeserializer::sptr shared();

    static MeshDeserializer::uptr unique();

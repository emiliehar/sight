...
class SessionDeserializer : public ISession
{
public:
    ...
    virtual ~SessionDeserializer() = default;

    /// Factories
    static SessionDeserializer::sptr shared();
    static SessionDeserializer::uptr unique();

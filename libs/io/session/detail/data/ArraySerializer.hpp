...
class ArraySerializer : public IDataSerializer
{
public:

    SIGHT_DECLARE_CLASS(ArraySerializer, IDataSerializer);

    /// Delete default copy constructors and assignment operators
    ArraySerializer(const ArraySerializer&)            = delete;
    ArraySerializer(ArraySerializer&&)                 = delete;
    ArraySerializer& operator=(const ArraySerializer&) = delete;
    ArraySerializer& operator=(ArraySerializer&&)      = delete;

    /// Default constructor
    ArraySerializer() = default;

    /// Default destructor
    ~ArraySerializer() override = default;

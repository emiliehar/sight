...
#include "modules/filter/imageItk/SPropagator.hpp"
...
void SPropagator::configuring()
{
    ...
    if(mode == "min")
    {
        m_mode = sight::filter::imageItk::MinMaxPropagation::MIN;
    }
    else if(mode == "max")
    {
        m_mode = sight::filter::imageItk::MinMaxPropagation::MAX;
    }
    else if(mode == "minmax")
    {
        m_mode = sight::filter::imageItk::MinMaxPropagation::MINMAX;
    }
    else
    {
...
void SPropagator::starting()
{
    ...
    if(isValid)
    {
        m_propagator = std::make_unique<sight::filter::imageItk::MinMaxPropagation>(imgIn, imgOut, nullptr);

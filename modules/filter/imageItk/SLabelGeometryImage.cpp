...
#include "modules/filter/imageItk/SLabelGeometryImage.hpp"
...
#include <filter/imageItk/Labeling.hpp>
...
void SLabelGeometryImage::updating()
{
    ...
    sight::filter::imageItk::computeCentroids(image.get_shared(), m_lPointListCentroids, m_lPointListLabels);

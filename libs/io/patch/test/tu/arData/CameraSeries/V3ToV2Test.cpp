...
{
    sight::atoms::Object::sptr CameraSeriesV3 = sight::atoms::Object::New();
    sight::atoms::Object::sptr CameraSeriesV2;
    ...
    {
        CameraSeriesV2 = sight::atoms::Object::dynamicCast(CameraSeriesV3->clone());

        io::atoms::patch::IPatch::NewVersionsType newVersions;
        newVersions[CameraSeriesV3] = CameraSeriesV2;

        patch::structural::data::CameraSeries::V3ToV2::sptr v3ToV2Patch;
        v3ToV2Patch = patch::structural::data::CameraSeries::V3ToV2::New();

...
CPPUNIT_TEST_SUITE_REGISTRATION(::sight::io::patch::structural::ut::data::DicomSeries::V2ToV1Test);
...
{
    sight::atoms::Object::sptr dicomSeriesV2 = sight::atoms::Object::New();
    sight::atoms::Object::sptr dicomSeriesV1;

    io::atoms::patch::helper::setClassname(dicomSeriesV2, "::sight::data::DicomSeries");
    io::atoms::patch::helper::setVersion(dicomSeriesV2, "2");

    io::atoms::patch::helper::Object helper(dicomSeriesV2);
    ...
    {
        dicomSeriesV1 = sight::atoms::Object::dynamicCast(dicomSeriesV2->clone());

        io::atoms::patch::IPatch::NewVersionsType newVersions;
        newVersions[dicomSeriesV2] = dicomSeriesV1;

        patch::structural::data::DicomSeries::V2ToV1::sptr v2ToV1Patch;
        v2ToV1Patch = patch::structural::data::DicomSeries::V2ToV1::New();
        CPPUNIT_ASSERT_NO_THROW(v2ToV1Patch->apply(dicomSeriesV2, dicomSeriesV1, newVersions));

        CPPUNIT_ASSERT(dicomSeriesV1);
        CPPUNIT_ASSERT_EQUAL(std::string("1"), io::atoms::patch::helper::getVersion(dicomSeriesV1));
